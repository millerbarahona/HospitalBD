...
$dao1 = new Paciente_Dao;
$paciente= $dao1->paciente_correo($correo);
$id=$paciente->getId();
$dao = new Visitas();
...
<body>
    <div class="container p-4">
                ...
                $row=$dao->get_visitaPaciEsp($visita);
                if($row==false){
                ...
                echo"<table class='table' id='tabla'>
                    ...
                    for($i=0;$i<count($row);$i++){
                        ...
                        echo "<td>
                    <a href='../Vista/verVisitas.php?id=".$row[$i]['id']."&accion=cancelada'><button type='button' class='btn btn-danger'><i class='far fa-calendar-times'></i></button></a></td>";
                    echo "</tr>";
                        echo "</tr>";
...
if(isset($_GET['id']) ){
    if(isset($_GET['accion'])){ 
        ...
        if($_GET['accion']=="realizada"){ 
            ...
            $visita1->setId($_GET['id']);
            $dao->SetEstado($visita1);
            header('location: ../Vista/VerVisitas.php');
        }
    }
}
